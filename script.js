...
const points = [
    ...
    //     lat: 46.544006, 
    //     lon: 30.729146, 
    //     label: "Заброшенный цех", 
    //     color: "#FF2D55", 
    //     image: "https://rizzexr.github.io/Rizzexr/Zabroshki/images/26.jpg",
    //     guarded: "Нет",
    //     difficulty: "1/3"
    // },
    // { 
        ...
        <div class="leaflet-popup-content">
            ...
            <div class="popup-content">
                ...
                <a href="https://www.google.com/maps/dir/?api=1&destination=${point.lat},${point.lon}" 
                   target="_blank" 
                   style="display: inline-block; margin-top: 10px; padding: 5px 10px; background: #FF2D55; color: white; text-decoration: none; border-radius: 5px;">
                   Построить маршрут
                </a>
            </div>
        </div>
